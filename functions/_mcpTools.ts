...
export const MCP_TOOLS = [
  ...
  },
  {
    name: "share_create",
    description:
      "Create a public share link for a file or folder. Returns JSON including a forwardable `url` and `token`. The plain `url` opens a landing page with a download button (files and folders alike); append `?download=1` for a direct download (folders download as a zip). Optional extract code (4-32 chars) and expiry in hours.",
    inputSchema: {
      type: "object",
      properties: {
