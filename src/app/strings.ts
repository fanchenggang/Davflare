...
const entries: Record<string, Entry> = {  searchPlaceholder: { zh: "搜索文件", en: "Search files" },
  ...
  siteHostnameLabel: { zh: "自定义域名", en: "Custom domain" },
  siteHostnameManage: { zh: "管理自定义域名", en: "Manage custom domain" },
  siteHostnameSet: { zh: "保存域名", en: "Save domain" },
  siteHostnameClear: { zh: "清除域名", en: "Clear domain" },
  siteHostnameBadge: { zh: "自定义域", en: "Custom domain" },
  siteHostnameDialogTitle: { zh: "自定义域名 — {name}", en: "Custom domain — {name}" },
  siteHostnameHint: {
    zh: "填写主机名（如 blog.example.com）。在 DNS 添加 CNAME 指向本 Pages 项目，并在 Cloudflare 给该项目绑定同一自定义域。站点会在该域名根路径提供（不是 /{slug}/）。不要填网盘域名或 SITES_HOST。",
    en: "Enter a hostname (e.g. blog.example.com). Add a DNS CNAME to this Pages project and bind the same custom domain in Cloudflare. The site is served at the domain root (not /{slug}/). Do not use your drive hostname or SITES_HOST.",
  },
  siteHostnameSaved: { zh: "自定义域名已更新", en: "Custom domain updated" },
  siteHostnameCleared: { zh: "已清除自定义域名", en: "Custom domain cleared" },
  siteHostnameInvalid: { zh: "域名格式无效", en: "Invalid hostname" },
