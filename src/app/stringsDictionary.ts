...
export type DictionaryEntry = { zh: string; en: string };
...
const entries: Record<string, DictionaryEntry> = {
  ...
  transfers: { zh: "传输任务", en: "Transfers" },
  ...
  save: { zh: "保存", en: "Save" },
  previewEdit: { zh: "编辑", en: "Edit" },
  previewSavedToast: { zh: "已保存", en: "Saved" },
  previewSaveFailed: { zh: "保存失败", en: "Save failed" },
  previewConflictToast: {
    zh: "文件已在其他端被修改，保存被拒绝；请先复制当前修改，再重新打开对比",
    en: "The file was changed elsewhere — save rejected. Copy your edits, then reopen to compare.",
  },
  previewDiscardTitle: { zh: "放弃修改？", en: "Discard changes?" },
  previewDiscardMessage: {
    zh: "关闭将丢失未保存的修改。",
    en: "Closing now will lose unsaved changes.",
  },
  previewDiscardConfirm: { zh: "放弃修改", en: "Discard" },
  name: { zh: "名称", en: "Name" },
  ...
  noTransferTasks: { zh: "暂无传输任务", en: "No transfers yet" },
  transferInProgress: { zh: "正在传输…", en: "Transferring…" },
  downloadedSoFar: { zh: "已下载 {size}", en: "Downloaded {size}" },
